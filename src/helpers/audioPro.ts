...
import { ambientEmitter, emitter } from './audioProEmitter'
import {
	guardTrackPlaying,
	logDebug,
	normalizeVolume,
...
export const AudioPro = {
	...
	configure(options: AudioProConfigureOptions): void {
		const { setConfigureOptions, setDebug, setDebugIncludesProgress } = useInternalStore.getState()
